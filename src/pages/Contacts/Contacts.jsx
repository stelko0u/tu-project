    ...
    <div className="bg-[#212121] min-h-screen p-4 sm:p-6 text-white flex justify-center items-center">
      <div className="w-full max-w-2xl flex flex-col md:flex-row">
        <div className="w-full md:w-1/2 md:pr-4 mb-8 md:mb-0">
          ...
          <h2 className="text-lg md:text-xl font-semibold mb-5 text-white">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              />
              {phoneEmptyError && (
                <p className="text-red-500 text-xs italic mt-1">{phoneEmptyError}</p>
              )}
              {phoneLengthError && (
        ...
        <div className="w-full md:w-1/2 md:pl-4">
          <h2 className="text-lg md:text-xl font-semibold mb-5 text-white mt-8 md:mt-0">
            Our contacts
          </h2>
      ...
      {isSuccess && (
        <div className="fixed top-24 right-4 w-11/12 sm:w-auto sm:max-w-md bg-green-500 text-white py-2 px-4 rounded-md shadow-lg z-50 transition-all duration-300 ease-out">
